...
\textbf{Our constrained motion planner and the small-space
  ...
  environment representations that might be more suited for perception
  systems. Extensions \cite{Nakhei4755945,DanLauLam2012} are currently
  under development to relax the a priori environment knowledge
  constraint and achieve reactive planning in unknown environments.}
